...
class Exp_LongNet(object):
    ...
    def _build_model(self):
        ...
        model = LongNetTS(
            ...
            dim_feedforward=512,
            segment_lengths=[96, 192, 384, 768, 1536],  # Example segment lengths adjusted for the input sequence length
    ...
    def _acquire_device(self):
        if self.args.use_gpu:
            os.environ['CUDA_VISIBLE_DEVICES'] = str(self.args.gpu if not self.args.use_multi_gpu else self.devices)
